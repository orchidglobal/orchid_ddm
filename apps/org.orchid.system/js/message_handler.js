!(function (exports) {
  ...
  const MessageHandler = {
    ...
    handleAlert: function (data) {
      LazyLoader.load('js/webapp/modal_dialog.js', () => {
    ...
    handleTextSelection: function (data) {
      LazyLoader.load('js/webapp/text_selection.js', () => {
        if (data.action === 'show') {
          TextSelection.show(
            data.selectedText,
            data.position.left,
    ...
    handleTitleTooltip: function (data) {
      LazyLoader.load('js/webapp/title_tooltip.js', () => {
        if (data.action === 'show') {
    ...
    handleKeyboard: function (data) {
      ...
      LazyLoader.load('js/webapp/keyboards.js', () => {
    ...
    handleWindowOpen: function (data) {
      const appWindow = new AppWindow('http://browser.localhost:9920/manifest.webapp', {
        url: data.url
      });
    },

    handlePictureInPicture: function (data) {
      LazyLoader.load('js/webapp/picture_in_picture.js', () => {
