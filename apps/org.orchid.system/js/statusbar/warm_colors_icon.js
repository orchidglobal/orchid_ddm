!(function (exports) {
  ...
  class StatusbarWarmColorsIcon extends StatusbarIcon {
    ...
    initialize () {
      ...
      OrchidJS.Settings.getValue('video.warm_colors.enabled').then(this.handleWarmColors.bind(this));
      OrchidJS.Settings.addObserver('video.warm_colors.enabled', this.handleWarmColors.bind(this));
    }
