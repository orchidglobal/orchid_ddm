  ...
  const ModalDialog = {
    ...
    showConfirm: function (title, message) {
      return new Promise((resolve, reject) => {
        ...
        cancelButton.addEventListener('click', this.handleCancelButtonClick.bind(this, resolve, false));

        const confirmButton = this.dialogConfirm.querySelector('.recommend');
        confirmButton.addEventListener('click', this.handleConfirmButtonClick.bind(this, resolve, true));
    ...
    showPermissionRequest: function (title, message, callback) {
      return new Promise((resolve, reject) => {
        ...
        cancelButton.addEventListener('click', this.handlePermissionRequestCancelButtonClick.bind(this, resolve));
        ...
        PermissionRequestButton.addEventListener(
          'click',
          this.handlePermissionRequestConfirmButtonClick.bind(this, resolve)
        );
    ...
    showValueSelector: function (title, options, defaultOption) {
      ...
      confirmButton.addEventListener(
        'click',
        this.handleValueSelectorConfirmButtonClick.bind(this, callback, defaultOption, true)
      );
